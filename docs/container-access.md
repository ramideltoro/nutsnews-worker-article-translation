...
Image: `ghcr.io/ramideltoro/nutsnews-worker-article-translation:<commit-sha>`

The publish workflow signs and pushes immutable SHA-tagged images. It does not publish mutable `latest` tags.
